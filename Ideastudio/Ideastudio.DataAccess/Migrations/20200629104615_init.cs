    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7771), "Namena 10", "Informacije o lokaciji 10", "Zona 10" },
                    { 9, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7769), "Namena 9", "Informacije o lokaciji 9", "Zona 9" },
                    { 7, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7765), "Namena 7", "Informacije o lokaciji 7", "Zona 7" },
                    { 6, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7763), "Namena 6", "Informacije o lokaciji 6", "Zona 6" },
                    { 8, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7767), "Namena 8", "Informacije o lokaciji 8", "Zona 8" },
                    { 4, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7759), "Namena 4", "Informacije o lokaciji 4", "Zona 4" },
                    { 3, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7756), "Namena 3", "Informacije o lokaciji 3", "Zona 3" },
                    { 2, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7732), "Namena 2", "Informacije o lokaciji 2", "Zona 2" },
                    { 1, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(6406), "Namena 1", "Informacije o lokaciji 1", "Zona 1" },
                    { 5, new DateTime(2020, 6, 29, 10, 46, 14, 830, DateTimeKind.Utc).AddTicks(7760), "Namena 5", "Informacije o lokaciji 5", "Zona 5" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 3458L, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(2701), 1, "Lokacijski uslovi 4", "Lokacijska dozvola 4", null, "Opsti podaci 4", 34534L },
                    { 2, 48643L, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(2682), 2, "Lokacijski uslovi 2", "Lokacijska dozvola 2", null, "Opsti podaci 2", 412L },
                    { 1, 6934L, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(1789), 3, "Lokacijski uslovi 1", "Lokacijska dozvola 1", null, "Opsti podaci 1", 324L },
                    { 5, 34343L, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(2703), 4, "Lokacijski uslovi 5", "Lokacijska dozvola 5", null, "Opsti podaci 5", 3483L },
                    { 3, 4843L, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(2698), 5, "Lokacijski uslovi 3", "Lokacijska dozvola 3", null, "Opsti podaci 3", 3453L }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6630), 3, 4, "Idejno resenje 5", 5 },
                    { 8, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6638), 2, 4, "Idejno resenje 8", 4 },
                    { 9, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6695), 4, 4, "Idejno resenje 9", 4 },
                    { 4, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6627), 4, 2, "Idejno resenje 4", 2 },
                    { 7, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6635), 1, 2, "Idejno resenje 7", 3 },
                    { 1, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(4979), 2, 1, "Idejno resenje 1", 4 },
                    { 6, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6632), 2, 1, "Idejno resenje 6", 3 },
                    { 2, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6594), 5, 5, "Idejno resenje 2", 1 },
                    { 10, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6698), 4, 5, "Idejno resenje 10", 5 },
                    { 3, new DateTime(2020, 6, 29, 10, 46, 14, 832, DateTimeKind.Utc).AddTicks(6623), 1, 3, "Idejno resenje 3", 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3101), 5, "Projekat 5", null, 1 },
                    { 9, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3108), 8, "Projekat 9", null, 1 },
                    { 3, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3095), 9, "Projekat 3", null, 1 },
                    { 8, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3106), 4, "Projekat 8", null, 1 },
                    { 2, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3070), 7, "Projekat 2", null, 1 },
                    { 4, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3099), 1, "Projekat 4", null, 1 },
                    { 10, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3110), 6, "Projekat 10", null, 1 },
                    { 1, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(1777), 2, "Projekat 1", null, 1 },
                    { 7, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3104), 10, "Projekat 7", null, 1 },
                    { 6, new DateTime(2020, 6, 29, 10, 46, 14, 833, DateTimeKind.Utc).AddTicks(3102), 3, "Projekat 6", null, 1 }
                });
